...
export default function Login() {
  ...
  }, [inputMode, triggerAutoScanLogin]);
  ...
  return (
    <div className="min-h-screen bg-neutral-100 flex flex-col lg:flex-row">
      ...
      <div className="order-2 lg:order-1 w-full lg:w-[320px] bg-white border-t lg:border-t-0 lg:border-r border-neutral-200 p-6 flex flex-col overflow-hidden shadow-lg z-10">
      ...
      <div className="order-3 lg:order-3 w-full lg:w-[360px] bg-white border-t lg:border-t-0 lg:border-l border-neutral-200 p-6 flex flex-col overflow-hidden shadow-lg z-10">
        <h2 className="text-2xl font-bold text-neutral-900 mb-6 flex items-center gap-2">
          <span className="relative flex h-3 w-3">
